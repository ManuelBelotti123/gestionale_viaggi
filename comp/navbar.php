<nav class="navbar navbar-expand navbar-dark shadow">
    <div class="container">
        <!-- Logo -->
        <a class="navbar-brand d-flex align-items-center" href="/gestionale_viaggi/dashboard_choose.php">
                    ...
                    <!-- Profile dropdown -->
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-dark" aria-labelledby="profileDropdown">
                                <li><a class="dropdown-item" href="/gestionale_viaggi/usrprofile/profile.php">Profilo</a></li>
